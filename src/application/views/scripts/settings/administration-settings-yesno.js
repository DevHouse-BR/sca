Settings.AdministrationSettingsYesNoForm = Ext.extend(Ext.Window, {
	id_settings: 0,
	modal: true,
	constrain: true,
	maximizable: false,
	...
	initComponent: function() {
		...
		this.comboyesnoL = new Ext.form.ComboBox({
			hiddenName:'value',
			editable: false,
			triggerAction: 'all',
			lazyRender:true,
			...
			store: new Ext.data.ArrayStore({
				...
				data: [['SIM', Application.app.language('controle.postagens.sim')], ['NAO', Application.app.language('controle.postagens.nao')]]
			}),
			valueField: 'value',
			displayField: 'name'
		});
	...
	onDestroy: function() {
		Settings.AdministrationSettingsYesNoForm.superclass.onDestroy.apply(this, arguments);
